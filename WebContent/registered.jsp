...
<table class="table table-bordered" style="width:300px;margin-left:50px;margin-top:50px;">
<tr>
	<th>NAME</th>
	<th>EMAIL</th>
</tr>
...
try
{
	...
	PreparedStatement st1=cn.prepareStatement("select name,email from users where email in(select email from registration where eid=?)");

...
try
{
	...
	PreparedStatement st1=cn.prepareStatement("select ename,edate,description from event where eid=?");
	st1.setString(1,request.getParameter("id"));
	ResultSet rs1=st1.executeQuery();
	rs1.next();
	String ename=rs1.getString(1);
	String edate=rs1.getString(2);
	...
	<form action=updateeventss.jsp>
	<input type="hidden" name=eid value =<%=request.getParameter("id") %>></input>
	<b style="font-size:24px;"><%=ename %> </b> <br>
	Date:
<select name=date>
<option>01</option>
<option>02</option>
...
<br>
	<textarea name="desc" style="background-color:rgba(0,0,0,0.7); color:white"><%=description %></textarea>
	<br>

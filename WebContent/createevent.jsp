...
<form action=createevents.jsp>
<b style="font-size:16px;">Event Name:</b> <input type="text" name="ename" style="margin-right:330px;">
<b style="font-size:16px;">Date of Event:</b>
<select name=date>
<option>01</option>
<option>02</option>
<option>03</option>
...
<br><br>
<b style="font-size:16px;">Event Description:</b>
<textarea name="description" rows="15" cols="40" style="background-color:rgba(0,0,0,0.7); color:white"></textarea>
